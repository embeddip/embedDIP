...
static const uint16_t RES_WIDTH_LOOKUP[IMAGE_RES_COUNT] = {
    IMAGE_RES_96X96_Width, IMAGE_RES_QQVGA_Width,   IMAGE_RES_QCIF_Width,
    IMAGE_RES_HQVGA_Width, IMAGE_RES_240X240_Width, IMAGE_RES_QVGA_Width,
    IMAGE_RES_CIF_Width,   IMAGE_RES_HVGA_Width,    IMAGE_RES_VGA_Width,
    IMAGE_RES_SVGA_Width,  IMAGE_RES_XGA_Width,     IMAGE_RES_HD_Width,
    IMAGE_RES_SXGA_Width,  IMAGE_RES_UXGA_Width,    IMAGE_RES_FHD_Width,
    IMAGE_RES_P_HD_Width,  IMAGE_RES_P_3MP_Width,   IMAGE_RES_QXGA_Width,
    IMAGE_RES_QHD_Width,   IMAGE_RES_WQXGA_Width,   IMAGE_RES_P_FHD_Width,
    IMAGE_RES_QSXGA_Width, IMAGE_RES_INVALID_Width, IMAGE_RES_CUSTOM_Width,
...
EMBEDDIP_STATIC_ASSERT((sizeof(RES_WIDTH_LOOKUP) /
                        sizeof(RES_WIDTH_LOOKUP[0])) == IMAGE_RES_COUNT,
                       "RES_WIDTH_LOOKUP size mismatch with IMAGE_RES_COUNT");

EMBEDDIP_STATIC_ASSERT((sizeof(RES_HEIGHT_LOOKUP) /
                        sizeof(RES_HEIGHT_LOOKUP[0])) == IMAGE_RES_COUNT,
 ...
 */
static inline uint8_t image_pixel_size_bytes(ImageFormat fmt,
                                             ImageDepth depth) {
