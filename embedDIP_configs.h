 ...
 */
#if !defined(EMBED_DIP_BOARD_STM32F7) && !defined(EMBED_DIP_BOARD_STM32H7S) && !defined(EMBED_DIP_BOARD_ESP32) && !defined(EMBED_DIP_BOARD_HOST)
...
#if !defined(EMBED_DIP_CPU_CORTEX_M7) && !defined(EMBED_DIP_CPU_LX6) && !defined(EMBED_DIP_CPU_LX7) && !defined(EMBED_DIP_CPU_NATIVE)
    #if defined(EMBED_DIP_BOARD_ESP32)
        /*
...
#if ((defined(EMBED_DIP_BOARD_STM32F7) ? 1 : 0) + (defined(EMBED_DIP_BOARD_STM32H7S) ? 1 : 0) + (defined(EMBED_DIP_BOARD_ESP32) ? 1 : 0) + (defined(EMBED_DIP_BOARD_HOST) ? 1 : 0)) == 0
    #error                                                                                         \
        "No board selected: define exactly one of EMBED_DIP_BOARD_STM32F7, EMBED_DIP_BOARD_STM32H7S, EMBED_DIP_BOARD_ESP32, or EMBED_DIP_BOARD_HOST."
#elif ((defined(EMBED_DIP_BOARD_STM32F7) ? 1 : 0) + (defined(EMBED_DIP_BOARD_STM32H7S) ? 1 : 0) + (defined(EMBED_DIP_BOARD_ESP32) ? 1 : 0) + (defined(EMBED_DIP_BOARD_HOST) ? 1 : 0)) > 1
    #error                                                                                         \
...
/* Sanity check: exactly one CPU variant. */
    ...
    #error                                                                                         \
        "No CPU selected: define exactly one of EMBED_DIP_CPU_CORTEX_M7, EMBED_DIP_CPU_LX6, EMBED_DIP_CPU_LX7, or EMBED_DIP_CPU_NATIVE."
