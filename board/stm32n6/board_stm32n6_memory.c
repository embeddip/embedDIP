...
static embeddip_status_t n6_allocate_region(embeddip_memory_region_t region, size_t size,
...
static embeddip_status_t n6_cache_span(const void *address, size_t size, uintptr_t *rounded_start,
